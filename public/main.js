...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.addContact = function (form) {
        var _this = this;
        if (form.invalid)
            return;
        var contact = form.value;
        this.contactService.addContact(contact).subscribe(function (res) {
    ...
    ContactComponent.prototype.deleteContact = function (id) {
        var _this = this;
        this.contactService.deleteContact(id).subscribe(function (res) {
...
module.exports = __webpack_require__(/*! /home/mdali/Documents/MEAN/contact-list/client/src/main.ts */"./src/main.ts");
